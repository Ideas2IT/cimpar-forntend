...
export const labTests: IMedicine[] = [
  { code: "1", display: "Complete Blood Count (CBC)", system: "" },
  { code: "4", display: "Basic Metabolic Panel (BMP)", system: "" },
  { code: "2", display: "Comprehensive Metabolic Panel (CMP)", system: "" },
  {
    code: "3",
    display: "COVID-19, FLU A & B, RSV PCR Panel (Swab)",
    system: "",
  },
  {
    code: "5",
    display:
      "Basic STD Panel (HIV, Syphilis, (Blood) Gonorrhea, Chlamydia, Trich (Urine))",
    system: "",
  },
  { code: "6", display: "Thyroid Panel (TSH, Free T4)", system: "" },
];
...
export const locations = [
  {
    id: "1",
    serviceCenterName: "Reya center new york",
    address_line1: "854 Avocado Ave. Newport Beach. CA. 92660",
    address_line2: "101 Independence Avenue, S.E. Washington, D.C. 20559",
    city: "city",
    state: "Alaska",
    zip: "12343",
    phone: "1234567889",
    email: "naything@gmail.com",
    contactPerson: "Ravinder Raina",
    status: "active",
    country: "USA",
  },
  {
    id: "2",
    serviceCenterName: "cimpar center new york",
    address_line1:
      "15205 North Kierland Blvd. Suite 100. Scottsdale. AZ. 85254",
    address_line2: "132 My Street, Kingston, New York 12401",
    city: "city",
    state: "Alaska",
    zip: "12343",
    phone: "1234567889",
    email: "naything@gmail.com",
    contactPerson: "Rahul David",
    status: "active",
    country: "USA",
  },
  {
    id: "3",
    serviceCenterName: "Health center new york",
    address_line1: "101 Independence Avenue, S.E. Washington, D.C. 20559",
    address_line2: "132 My Street, Kingston, New York 12401",
    city: "city",
    state: "Alaska",
    zip: "12343",
