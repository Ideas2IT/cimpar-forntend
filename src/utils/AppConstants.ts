...
export const SERVICE_CATEGORY_NAME = {
  [SERVICE_MENU.LABORATORY]: LAB_SERVICES.CLINICAL_LABORATORY,
  [SERVICE_MENU.IMAGING]: LAB_SERVICES.IMAGING,
  [SERVICE_MENU.HOME_CARE]: LAB_SERVICES.HOME_CARE,
};
